        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'โน๊ตบุ๊ค', price: 20000, inStock: true },
                        { id: 2, name: 'เมาส์', price: 3100, inStock: true },
                        { id: 3, name: 'คีย์บอร์ด', price: 4290, inStock: false }
                    ].map(product => (
